                        ...
                        <div class="swichermainleft text-center">
                            <div class="p-3">
                                ...
                                <a href="https://www.rtl-theme.com/author/amir-h67/"
                                    class="btn btn-info btn-block">نمونه کارها </a>
                            </div>
                        </div>
    ...
    <div class="page">
        ...
        <div class="main-sidebar main-sidebar-sticky side-menu">
            ...
            <div class="main-sidebar-body">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/dashboard"><span class="shape1"></span><span
                    ...
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span
                                ...
                                class="sidemenu-label">اسلایدر</span><i class="angle fe fe-chevron-left"></i></a>
                        <ul class="nav-sub">
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{ route('slider.create') }}">ایجاد</a>
                            </li>
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{ route('slider.index') }}">لیست</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span
                                class="shape2"></span><i class="ti-wallet sidemenu-icon"></i><span
                                class="sidemenu-label">دسته بندی</span><i class="angle fe fe-chevron-left"></i></a>
                        <ul class="nav-sub">
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{ route('productCat.create') }}">ایجاد</a>
                            </li>
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{ route('productCat.index') }}">لیست</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span
                                class="shape2"></span><i class="ti ti-wallet sidemenu-icon"></i><span
                                class="sidemenu-label">برند</span><i class="angle fe fe-chevron-left"></i></a>
                        <ul class="nav-sub">
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{ route('brand.create') }}">ایجاد</a>
                            </li>
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{ route('brand.index') }}">لیست</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span
                                class="shape2"></span><i class="ti-wallet sidemenu-icon"></i><span
                                class="sidemenu-label">محصولات</span><i class="angle fe fe-chevron-left"></i></a>
                        <ul class="nav-sub">
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{ route('product.create') }}">ایجاد</a>
                            </li>
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{ route('product.index') }}">لیست</a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <div class="dropdown-menu">
                            <div class="main-form-search p-2">
                                <div class="input-group">
                                    ...
                                    <button class="btn search-btn"><svg xmlns="http://www.w3.org/2000/svg" width="20"
                    ...
                    <div class="dropdown main-header-notification">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <div class="main-notification-list">
                                <div class="media new">
                                    <div class="main-img-user online"><img alt="آواتار" src="/assets/img/users/5.jpg">
                                    </div>
                                ...
                                <div class="media">
                                    <div class="main-img-user online"><img alt="آواتار" src="/assets/img/users/3.jpg">
                                    </div>
                                    <div class="media-body">
                        ...
                        <div class="dropdown main-header-notification">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="main-notification-list">
                                    ...
                                    <div class="media">
                                        <div class="main-img-user"><img alt="آواتار" src="/assets/img/users/2.jpg">
                                        </div>
                                        <div class="media-body">
        ...
        <div class="sidebar sidebar-left sidebar-animate">
            <div class="sidebar-icon">
                <a href="#" class="text-right float-left text-dark fs-20" data-toggle="sidebar-left"
                    data-target=".sidebar-left"><i class="fe fe-x"></i></a>
            </div>
            <div class="sidebar-body">
                ...
                <div class="d-flex p-3">
                    ...
                    <span class="mr-auto">
                        <i class="fe fe-edit-2 text-primary mr-2" data-toggle="tooltip" title="" data-placement="top"
                            data-original-title="ویرایش کنید"></i>
                ...
                <div class="d-flex p-3 border-top">
                    <label class="ckbox"><input checked="" type="checkbox"><span>سیستم به روز
                            شد</span></label>
                    <span class="mr-auto">
                        <i class="fe fe-edit-2 text-primary mr-2" data-toggle="tooltip" title="" data-placement="top"
                            data-original-title="ویرایش کنید"></i>
