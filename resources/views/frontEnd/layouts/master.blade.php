            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('login') }}" method="post">
                        ...
                        <div class="right-w3l">
                            <a class="btn btn-primary col-sm-12" href="{{url('auth/google')}}">Login with google account</a>
                        </div>
                        <div class="sub-w3l">
                ...
                <div class="modal-body">
                    <form action="{{ route('front.register') }}" method="post">
                        ...
                        <div class="right-w3l">
                            ...
                            <a class="col-sm-12" href="{{ url('auth/google') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-2 top_nav_right text-center mt-sm-0 mt-2">
                            <div class="wthreecartaits wthreecartaits2 cart cart box_1">
                                <form action="{{ url('checkOut') }}" method="post" class="last">
                                    <input type="hidden" name="cmd" value="_cart">
                                    <input type="hidden" name="display" value="1">
                                    <a href="{{ url('checkOut') }}" class="btn w3view-cart" type="submit" name="submit" value="">
